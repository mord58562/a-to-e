...
DIAGNOSES = [
    ...
    ("placental abruption", [r"\bplacental abruption\b", r"\babruption\b"]),
    ("placenta praevia", [r"\bplacenta praevia\b", r"\bplacenta previa\b"]),
    ("placenta accreta", [r"\bplacenta accreta\b", r"\baccreta\b", r"\bmorbidly adherent\b"]),
    ...
    ("ALL", [r"\bacute lymphoblastic leukaemia\b", r"\bALL\b"]),
    ("AML", [r"\bacute myeloid leukaemia\b", r"\bAML\b"]),
    ...
    ("obstetric cholestasis", [r"\bobstetric cholestasis\b", r"\bICP\b"]),
